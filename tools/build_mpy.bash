...
sed 's~$(VINDRIKTNING_SRC_ROOT)~'"$SRC_ROOT"'~g' < "$SRC_ROOT/tools/manifest.py" > "$BUILD_ROOT/micropython/ports/esp32/boards/ESP32_GENERIC/manifest.py"
cp -f "$SRC_ROOT/tools/mpconfigboard.cmake" "$BUILD_ROOT/micropython/ports/esp32/boards/ESP32_GENERIC/"
